...
<%--<%@ page errorPage="warden-error-page.jsp" %>--%>
<%--<!DOCTYPE html>--%>
...
<%--<!-- Sidebar Navigation -->--%>
<%--<aside class="flex flex-col fixed left-0 top-0 h-full h-screen w-64 bg-slate-100 z-50 border-r-0">--%>
<%--    <div class="px-6 py-8">--%>
...
<%--    <!-- Top Navigation Bar -->--%>
<%--    <header class="flex justify-between items-center w-full px-8 py-4 sticky top-0 z-40 bg-white/70 backdrop-blur-xl shadow-sm shadow-blue-900/5">--%>
...
<%--    &lt;%&ndash;    Page Content of Warden-login-dashboard Page&ndash;%&gt;--%>

<%--    &lt;%&ndash; Start warden login dashboard &ndash;%&gt;--%>
<%--    <div id="post-container" class="p-10 max-w-[1400px] mx-auto">--%>
<%--        <!-- Welcome Header -->--%>
<%--        <div class="mb-10 flex justify-between items-end">--%>
<%--            <div>--%>
<%--                <h2 class="font-headline text-4xl font-extrabold text-primary tracking-tight mb-2">Welcome Warden Sir:--%>
<%--                    B5 Top Floor</h2>--%>
...
<%--            <!-- Total Rooms -->--%>
<%--            <div class="bg-surface-container-lowest p-6 rounded-xl border border-transparent hover:border-outline-variant/30 transition-all duration-300">--%>
<%--                <div class="flex justify-between items-start mb-4">--%>
<%--                    <div class="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center text-primary">--%>
<%--                        <span class="material-symbols-outlined text-3xl" data-icon="hotel">hotel</span>--%>
<%--                    </div>--%>
<%--                    <span class="text-xs font-bold text-primary px-2 py-1 bg-primary-container/10 rounded-full">Total Capacity</span>--%>
<%--                </div>--%>
<%--                <div class="space-y-1">--%>
<%--                    <h3 class="text-3xl font-black text-on-surface">208--%>
<%--                    </h3>--%>
<%--                    <p class="text-sm text-on-surface-variant font-medium">Total Rooms: 27</p>--%>
<%--                </div>--%>
...
<%--                        <span class="material-symbols-outlined text-3xl" data-icon="assignment">assignment</span>--%>
<%--                    </div>--%>
<%--                    <span class="text-xs font-bold text-indigo-700 px-2 py-1 bg-indigo-100 rounded-full">Room Space</span>--%>
<%--                </div>--%>
<%--                <div class="space-y-1">--%>
<%--                    <h3 class="text-2xl font-black text-on-surface">8 Student</h3>--%>
<%--                    <p class="text-sm text-on-surface-variant font-medium">Every Room</p>--%>
<%--                </div>--%>
<%--                <div class="mt-4 pt-4 border-t border-outline-variant/10">--%>
<%--                    <div class="w-full bg-surface-container-low h-1.5 rounded-full overflow-hidden">--%>
<%--                        <div class="bg-indigo-500 h-full w-[82%]"></div>--%>
<%--                    </div>--%>
<%--                </div>--%>
<%--            </div>--%>
<%--            <!-- Available Rooms -->--%>
...
<%--                </div>--%>
<%--                <% // count the available student in room_allotment table--%>
<%--                    int count = dao.CountValue.countAllotRoom();--%>
<%--                %>--%>
<%--                <div class="space-y-1">--%>
<%--                    <h3 class="text-3xl font-black text-on-surface"><%=208 - (count)%>--%>
<%--                    </h3>--%>
<%--                    <p class="text-sm text-on-surface-variant font-medium">Available Total Bad</p>--%>
<%--                </div>--%>
<%--                <div class="mt-4 pt-4 border-t border-outline-variant/10">--%>
<%--                    <div class="w-full bg-surface-container-low h-1.5 rounded-full overflow-hidden">--%>
...
<%--                </div>--%>
<%--                <div class="space-y-1">--%>
<%--                    <h3 class="text-3xl font-black text-on-surface"><%=count%>--%>
<%--                    </h3>--%>
<%--                    <p class="text-sm text-on-surface-variant font-medium">Total Students</p>--%>
<%--                </div>--%>
<%--                <div class="mt-4 pt-4 border-t border-outline-variant/10">--%>
<%--                    <div class="w-full bg-surface-container-low h-1.5 rounded-full overflow-hidden">--%>
...
<%--                <h3 class="font-headline text-xl font-bold text-primary">Recent Student Allotments</h3>--%>
<%--            </div>--%>
<%--            <div class="overflow-x-auto">--%>
<%--                <table class="w-full text-left"> <!-- Table Details -->--%>
<%--                    <thead>--%>
...
<%--                                <div>--%>
<%--                                    <p class="font-bold text-on-surface text-sm"><%=student.getName()%>--%>
<%--                                    </p>--%>
<%--                                    <p class="text-[10px] text-outline font-medium"><%=student.getBranch()%>--%>
<%--                                    </p>--%>
<%--                                </div>--%>
<%--                            </div>--%>
<%--                        </td>--%>
...
<%--                            </div>--%>
<%--                        </td>--%>
<%--                        <td class="px-8 py-5 text-sm font-medium text-on-surface-variant"><%=student.getAllot_date()%>--%>
<%--                        </td>--%>
<%--                        <td class="px-8 py-5 text-center">--%>
<%--                            <span class="px-3 py-1 rounded-full text-[10px] font-black uppercase bg-secondary-fixed text-on-secondary-fixed"><%=student.getCourse()%></span>--%>
<%--                        </td>--%>
...
<%--            <div class="lg:col-span-2 bg-gradient-to-br from-primary to-secondary p-8 rounded-xl text-white relative overflow-hidden group">--%>
<%--                <div class="relative z-10 max-w-lg">--%>
<%--                    <h4 class="text-2xl font-black mb-2">Hostel Maintenance Notice</h4>--%>
<%--                    <p class="text-blue-100 mb-6 text-sm">Students are hereby informed that hostel maintenance will be--%>
<%--                        carried out as scheduled; therefore, students are requested not to disturb the process. For any--%>
<%--                        queries, please contact the warden at 9031901500.</p>--%>
<%--                    <button class="bg-white text-primary px-5 py-2 rounded-lg text-xs font-bold hover:bg-blue-50 transition-colors">--%>
...
<%--                    <span class="material-symbols-outlined text-9xl" data-icon="construction">construction</span>--%>
<%--                </div>--%>
<%--            </div>--%>
...
<%--                    </div>--%>
<%--                    <h4 class="font-headline text-lg font-bold text-primary">Capacity Alert</h4>--%>
<%--                </div>--%>
<%--                <p class="text-sm text-on-surface-variant mb-4">Hostel is currently at <span--%>
<%--                        class="font-bold text-on-surface"><%=percentValue%>%</span> capacity. Expected full occupancy by--%>
<%--                    next Month.</p>--%>
<%--                <div class="w-full bg-surface-container-low h-2 rounded-full mb-6">--%>
<%--                    <div class="bg-gradient-to-r from-primary to-secondary h-full"--%>
<%--                         style="width: <%=percentValue%>%;"></div>--%>
<%--                </div>--%>
<%--                <a class="text-primary text-xs font-bold flex items-center gap-2 hover:gap-3 transition-all" href="#">--%>
<%--                    VIEW DETAILED ANALYTICS <span class="material-symbols-outlined text-sm" data-icon="arrow_forward">arrow_forward</span>--%>
<%--                </a>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
<%--    &lt;%&ndash; End warden login dashboard&ndash;%&gt;--%>
...
<%--    <!-- Footer -->--%>
<%--    <footer class="px-10 py-8 border-t border-outline-variant/10 mt-12 text-center">--%>
    ...
    <div id="post-container" class="p-4 sm:p-6 lg:p-10 max-w-[1400px] mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            <div class="bg-surface-container-lowest p-4 sm:p-6 rounded-xl border border-transparent hover:border-outline-variant/30 transition-all duration-300">
                ...
                <div class="space-y-1">
                    <h3 class="text-2xl sm:text-3xl font-black text-on-surface">208</h3>
            ...
            <div class="bg-surface-container-lowest p-4 sm:p-6 rounded-xl border border-transparent hover:border-outline-variant/30 transition-all duration-300">
                ...
                <div class="space-y-1">
                    <h3 class="text-2xl sm:text-3xl font-black text-on-surface"><%=208 - count%></h3>
